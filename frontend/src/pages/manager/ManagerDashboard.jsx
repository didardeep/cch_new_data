  ...
  return (
    <div>
      ...
      {pendingEscalations > 0 && (
        <div style={{ ...ESCALATION_BANNER_STYLE, background: isDark ? '#2e1065' : '#fdf4ff', border: `1px solid ${isDark ? '#581c87' : '#e9d5ff'}` }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <span style={{
              width: 36, height: 36, borderRadius: 8, background: isDark ? '#581c87' : '#f3e8ff',
            ...
            <div>
              <div style={{ fontSize: 14, fontWeight: 700, color: isDark ? '#e9d5ff' : '#3b0764' }}>
                {pendingEscalations} escalation{pendingEscalations > 1 ? 's' : ''} awaiting your review
              </div>
              <div style={{ fontSize: 12, color: isDark ? '#c084fc' : '#7e22ce', marginTop: 2 }}>
