...
const IC = {
  ...
  escalate: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="18 15 12 9 6 15"/><line x1="12" y1="9" x2="12" y2="21"/><path d="M4 4h16"/></svg>,
...
export default function AgentDashboard() {
  ...
  const kpiRows = [
    ...
    { label:'Complaint Resolution',      value: kpis.complaint_resolution_time ?? 0,     unit:'hrs', icon: IC.clip,   sub:'End-to-end resolution' },
